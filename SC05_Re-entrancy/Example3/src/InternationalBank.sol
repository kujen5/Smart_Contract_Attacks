...
contract InternationalBank {
    ...
    function withdrawETH() public {
        ...
        //bytes memory data = abi.encodeWithSignature("getAttackerContractBalance()");
        //(bool success,) = msg.sender.call{value: userBalance}(data);
        (bool success,) = msg.sender.call{value: userBalance}("Random calldata");
